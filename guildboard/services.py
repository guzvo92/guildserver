################################     CONSTRUCTORES      #######################################
import requests
from guildboard.services_filemakers import *


sizelist = 100
creandofilemodelos(sizelist,"guildboard/auto_models.py") #crea archivo de MODELOS
creandoautofile(sizelist,"guildboard/auto_file.py") #me crea los N modelos finales

print("\n")

############################## EMPIEZAN Services del componente ##################################
from guildboard.auto_models import *
from guildboard.auto_file import *
from guildboard.services_singles import *
from guildboard.models import *
